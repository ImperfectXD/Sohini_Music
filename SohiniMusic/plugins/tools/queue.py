...
import config
from SohiniMusic import app
from SohiniMusic.misc import db
from SohiniMusic.utils import AviaxBin, get_channeplayCB, seconds_to_min
from SohiniMusic.utils.database import get_cmode, is_active_chat, is_music_playing
from SohiniMusic.utils.decorators.language import language, languageCB
from SohiniMusic.utils.inline import queue_back_markup, queue_markup
...
async def queued_tracks(client, CallbackQuery: CallbackQuery, _):
    ...
    med = InputMediaPhoto(
        media="Uploaded to https://graph.org/file/e18521fa659372e8810b2.jpg)",
        caption=_["queue_1"],
    )
